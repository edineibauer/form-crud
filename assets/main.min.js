    ...
    function reloadForm(entity, id) {
        ...
        post('form-crud', 'children/form', {
            ...
            if (data) {
                ...
                if ($ontab.length) {
                    $ontab.loading();
                    toast("Cadastro Salvo", 2500, "toast-success");
                } else {
                    $form.loading();
                }
                if (id) {
...
if (typeof formAutoSubmit !== 'function') {
    ...
    function animateCloseHeightNewMult($div, closebarInstant) {
        ...
        $panel.find(".div-blur").removeClass("focus-blur");
        if($panel.closest(".parent-relation").length) {
            $panel.closest(".parent-relation").find(".div-blur:not(.rest)").removeClass("focus-blur");
        } else {
