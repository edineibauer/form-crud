...
Dropzone.autoDiscover=!1;function loadForm(){$(".table-search").prop("disabled",!0);setTimeout(function(){$(".table-search").prop("disabled",!1)},1000);$(".form-crud").off("click","#saveFormButton").on("click","#saveFormButton",function(){formSave($(this).closest(".form-crud"),!0)});loadMask();formAutoSubmit(".form-control")}loadForm();