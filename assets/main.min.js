...
if (typeof formSubmit !== 'function') {
    ...
    function reloadForm(entity, id) {
        ...
        if(var $btnSave = $("#form_" + entity).find("#saveFormButton").length) {
        ...
        post('form-crud', 'children/form', {entity: entity, id: id, fields: fields, callback: callback, btnClass: btnClass, btnText: btnText, btnIcon: btnIcon}, function (data) {
            if (data) {
