...
Dropzone.autoDiscover=!1;function loadForm(){$(".form-crud").off("click","#saveFormButton").on("click","#saveFormButton",function(){formSave($(this).closest(".form-crud"),!0)});loadMask();formAutoSubmit(".form-control")}loadForm();