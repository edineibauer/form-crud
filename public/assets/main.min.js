...
if (typeof formAutoSubmit !== 'function') {
    function formAutoSubmit($element) {
        ...
        }).off("click focus", "input[type='password'], input[type='text'], input[type='email'], input[type='tel']").on("click focus", "input[type='password'], input[type='text'], input[type='email'], input[type='tel']", function () {
