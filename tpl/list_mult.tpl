<div class="{$form['class']} parent-input parent-relation col" {$form['atributos']} style="{$form['style']}">
    <label for="{$column}" class="col padding-0 padding-bottom color-text-grey">
        {$nome} {($default === false) ? "*" : ""}
    </label>
    <div class="col radius border" style="background: rgba(200,200,200, 0.1);">
        <div class="row list_mult_input">
            ...
            <div class="container listmult-content">
                {if $value}
                    {foreach item=data key=i from=$value}
                        <div class="listmult-card"
                             style="{if $i>1}border-top: solid 1px #DDD;{/if}margin-bottom: 2px!important;"
                             rel="{$data.id}">
            ...
            <div class="tpl_list_mult hide listmult-card transition-easy"
                 style="border-top: solid 1px #DDD;margin-bottom: 2px!important;" rel="__$0__">
                <div class="col padding-small container" style="width:30px">
                    <i class="material-icons padding-8">{$icon}</i>
                </div>
                <div class="rest relative" style="padding-top:4px">
